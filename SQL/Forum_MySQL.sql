...
create table smileys (
	smiley_id int auto_increment primary key,
	smiley_name varchar(50),
	smiley_url varchar(50)
);

insert into smileys (smiley_name,smiley_url) values ('cool','images/icons/cool.gif');
insert into smileys (smiley_name,smiley_url) values ('mad','images/icons/mad.gif');
insert into smileys (smiley_name,smiley_url) values ('sad','images/icons/sad.gif');
insert into smileys (smiley_name,smiley_url) values ('big grin','images/icons/biggrin.gif');
insert into smileys (smiley_name,smiley_url) values ('colgate','images/icons/colgate.gif');
insert into smileys (smiley_name,smiley_url) values ('confused','images/icons/confused.gif');
insert into smileys (smiley_name,smiley_url) values ('sigh','images/icons/sigh.gif');
insert into smileys (smiley_name,smiley_url) values ('smile','images/icons/smile.gif');
insert into smileys (smiley_name,smiley_url) values ('tongue','images/icons/tounge.gif');
insert into smileys (smiley_name,smiley_url) values ('wink','images/icons/wink.gif');
insert into smileys (smiley_name,smiley_url) values ('wow!','images/icons/wow.gif');
